...
def activity_perturb_backward_hook(module, grad_input, grad_output, dest='target'):
    ...
    if dest == 'guess':
        if hasattr(module, 'random_flag'):
            ...
            # where is module.target for the first time dest='target'?
